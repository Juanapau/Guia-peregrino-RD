const BOOK_DATA = [
  {
    ...
    "paragraphs": [
      ...
      "Un nuevo día con su carga \nde ilusiones,\nde esperanzas,\nde servicio a los demás,\nde alegrías y dolores,\nde risas y lágrimas,\nde compromisos...",
      "Todo será hermoso, aún el dolor, si está \niluminado por TU LUZ.",
      ...
      "ÁNGELUS",
      "(En el Tiempo de Pascua se reza el “Regina Coeli” en vez del Ángelus. Pág. 11)",
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      "La MEDITACIÓN es uno de los mejores medios para conocer a Cristo,\nque me sigue,\nque me acompaña,\nque se sugiere en mi vida,\nque me interpela.",
      "Y para conocerme a mí, con mi circunstancia interna, viéndome por dentro como Dios me ve. Y con mi circunstancia externa, viendo, bajo su luz, la problemática de la Iglesia y del mundo en que estoy inmerso.",
      ...
      "Santa María, intercede por nosotros, para que todas nuestras intenciones, palabras y acciones de este día vayan dirigidas únicamente a mayor gloria de Dios. Amén."
    ]
  },
  {
    "title": "Santa Misa",
    ...
    "paragraphs": [
      ...
      "La Misa es la ACCIÓN DE GRACIAS de la Iglesia, por las maravillas que Dios obra constantemente, salvándonos en la PACUA DE CRISTO, muerto y resucitado.",
      "La Misa es el MEMORIAL de la Pasión y la Muerte del Señor, y el ANUNCIO de su retorno final.",
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      "El culto a la Virgen, “de raíces profundas en la Palabra revelada, y de sólidos fundamentos dogmáticos”, “tiene su razón última en el designio insondable y libre de Dios, el cual, siendo caridad eterna y divina, lleva a cabo todo según un designio de amor; la amó y obró en Ella maravillas, la amó por Sí mismo, la amó por nosotros; se la dio a Sí mismo y nos la dio a nosotros”.",
      "Puesto que Ella “ocupa en la Santa Iglesia el lugar más alto y a la vez, más próximo a nosotros”, acudamos a la Madre, para implorar su intercesión.",
      "No en vano el concilio la proclamó “signo de esperanza cierta y de consuelo” para el Pueblo de Dios en marcha.\n    3. SANTO ROSARIO",
      "Señal de la Cruz",
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      "¿Has guardado tus talentos, o los pusiste al  servicio de mis hermanos, los hombres? ¿Has saciado mi sed, mi hambre, mi tristeza, mi soledad, en quienes encontraste en tu camino?",
      "Y ante la injusticia, la calumnia, cometida contra Mí en mis hermanos, ¿Qué has hecho? Alguien que se haya cruzado contigo, ¿se fue con las manos vacías o con el \ncorazón más frío ...?",
      "¿Has contribuido con tu trabajo a que el mundo –ese pequeño mundo en el cual te mueves: familia, profesión, sociedad ...– se transforme según los designios de Dios? ¿Crees que hoy te has asociado en algo a \nmi obra redentora?",
      "¿Has transmitido alguna “noticia” mía a través de tu palabra? ¿Dejaste en algún momento de ser testigo mío?",
      "¿Has intentado profundizar, de cualquier forma, en el conocimiento de mi Palabra?",
      "¿En qué momento te has sentido hoy más cerca de Mí?",
      "HÁBLALE TÚ AL SEÑOR",
      "(Silencio)",
      "ACTO DE CONTRICIÓN\n(de pie)\nTodos:\nYo confieso ante Dios Todopoderoso y ante ustedes hermanos, que he pecado mucho de pensamiento, palabra, obra y omisión: Por mi culpa, por mi culpa, por mi gran culpa. Por eso ruego a Santa María, siempre Virgen, a los Ángeles, a los Santos y a ustedes hermanos, que intercedan por mí ante Dios, Nuestro Señor.",
  ...
  },
  {
    ...
    "paragraphs": [
      "V I I",
      "VIA CRUCIS",
      "Queremos ser conscientes, Señor, de TU PASIÓN.\nDe la Pasión que sufriste entonces,\npero también de tu Pasión de ahora.\nRepetida en tu Iglesia,\nen nuestros hermanos,\nen nuestro pueblo,\nen nuestro lugar ...",
      "Sabemos como se comportaron contigo los\nhombres de entonces.",
      "Hoy, en tu VIA CRUCIS de nuestros días,\nsabemos como estamos comportándonos\nnosotros.",
      "Por eso podemos deducir cual habría sido\nentonces nuestra actitud.",
      "Sin temores, vamos a sentirnos ahora contigo, Jesús, protagonistas de tu caminar hacia la Cruz, de tu subida al monte de la Redención.\nTodos:\n Por la señal de la Santa Cruz ...",
      "Todos:\nSeñor mío Jesucristo, Dios y hombre verdadero, Creador Padre y Redentor mío. Por ser Tú quien eres, Bondad infinita, y porque te amo sobre todas las cosas, me pesa de todo corazón haberte ofendido. También me pesa, porque puedes castigarme con las penas del infierno. Ayudado por tu divina gracia, propongo firmemente nunca más pecar, confesarme y cumplir la penitencia que me fuese impuesta. Amén.\nI  VIA CRUCIS",
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      "Un examen se ha de hacer por el contraste de lo que soy con lo que debo ser; de mi vida real con el ideal que debo vivir. Este ideal lo debo encontrar preferentemente en el Evangelio, en las formulaciones del Magisterio de la Iglesia y en el mismo rito sacramental.",
  ...
  },
  {
    ...
    "paragraphs": [
      ...
      "9. ACCION DE GRACIAS DESPUÉS DE LA COMIDA",
      ...
      "10. BENDICIÓN CON EL SANTÍSIMO SACRAMENTO",
      "(de rodillas)\nCanto de adoración",
      ...
      "(El sacerdote o diácono da la Bendición con el Santísimo en silencio  y, a continuación, el ministro enuncia las siguientes bendiciones, que todos repiten).",
